...
import { Square, Cat, Dog, Leaf, Sparkles, X, RotateCcw, Play } from 'lucide-react';
    ...
    return (
        ...
        <div className={`min-h-screen font-sans transition-colors duration-500 relative flex flex-col ${t.bg}`}>
                                            ...
                                            <div className="relative w-full flex-1 flex items-center justify-center rounded-lg sm:rounded-xl overflow-hidden mb-2 bg-black/20 group-hover:scale-105 transition-transform duration-300">
                                                ...
                                                <div className="absolute inset-0 flex items-center justify-center opacity-100 sm:opacity-0 group-hover:opacity-100 bg-black/10 sm:bg-black/40 transition-all gap-4">
                                                    <button
                                                        ...
                                                        className="p-3 sm:p-4 bg-blue-500 hover:bg-blue-400 rounded-full text-white shadow-lg hover:scale-110 transition-all flex flex-col items-center justify-center z-10"
                                                    ...
                                                    {book.last_page > 1 && (
                                                        <button
                                                            ...
                                                            className="p-3 sm:p-4 bg-amber-500 hover:bg-amber-400 rounded-full text-white shadow-lg hover:scale-110 transition-all flex flex-col items-center justify-center z-10"
            ...
            <footer className="w-full text-center p-4 mt-auto text-xs opacity-60">
                <p>Amori v1.6.1 DEFINITIVA &copy; {new Date().getFullYear()} Adamo. All rights reserved.</p>
            </footer>
        </div >
    )
}
