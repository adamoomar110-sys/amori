...
export const getPageText = async (docId, pageNum, translate = false) => {
    const response = await axios.get(`${API_BASE}/document/${docId}/page/${pageNum}/text?translate=${translate}`);
    return response.data;
};
